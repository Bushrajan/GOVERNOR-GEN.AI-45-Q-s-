...
operations in print statements.Explain & TIP: Play with numbers to get 8
using different math operations. It's a fun way to see how you can perform
...
once on each line.
Explain & TIP: Just like before, use basic math operations to display 
...
Explain & TIP: Use a variable to remember your favorite number. Then,
show a message with it. This is a great way to see how variables can hold
different types of data, like numbers.*/
console.log("\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Day3_Q3: xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");
